...
if not DB_URL:
    ...
    print('File location: zivaa-backend/migrations/038_add_lifestyle_habits_to_plan_setup.sql')
    exit(1)

migration_file = 'migrations/038_add_lifestyle_habits_to_plan_setup.sql'
...
try:
    ...
    cursor = conn.cursor()
    print('Executing Migration 038...')
    cursor.execute(sql)
    print('Migration 038 applied successfully!')
    conn.close()
except Exception as e:
    print(f'Error applying migration 038: {e}')
