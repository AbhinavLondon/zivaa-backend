...
if not DB_URL:
    ...
    print('File location: zivaa-backend/migrations/035_convert_vitals_hourly_to_table.sql')
    exit(1)

migration_file = 'migrations/035_convert_vitals_hourly_to_table.sql'
...
try:
    ...
    cursor = conn.cursor()
    print('Executing Migration 035...')
    cursor.execute(sql)
    print('Migration 035 applied successfully!')
    conn.close()
except Exception as e:
    print(f'Error applying migration 035: {e}')
