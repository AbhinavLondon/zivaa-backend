...
def setup_cron_jobs():
    from app.services.scheduler_jobs import run_morning_fallback, run_daily_longevity_fallback, run_weekly_caregiver_digest, run_midday_checkins, run_evening_checkins, run_weekly_planning, run_weekly_longevity_strategy, run_weekly_retest_digest
