-- Migration 011: Add heart_rate_recovery_calculated JSON array to vitals_daily
...
FROM ((((((other_metrics o
    ...
    FULL JOIN hrr_daily hrr ON (((COALESCE(o.patient_id, h.patient_id, ox.patient_id, s.patient_id, r.patient_id, sp.patient_id, ms.patient_id, spf.patient_id) = hrr.patient_id) AND (COALESCE(o.date, h.date, ox.date, s.date, r.date, sp.date, ms.date, spf.date) = hrr.date)));
