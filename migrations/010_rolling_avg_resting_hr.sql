-- Migration 010: Update resting_heart_rate_calculated to use a 5-minute rolling average minimum
-- Problem: resting_heart_rate_calculated was a simple average of all heart rate samples during sleep.
-- Fix: Calculate a 5-minute rolling average for all samples during sleep, and select the lowest single 5-minute average for the night as the resting heart rate.
