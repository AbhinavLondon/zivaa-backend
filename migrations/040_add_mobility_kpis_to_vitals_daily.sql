-- Migration 040: Add mobility KPIs (avg_cadence_spm, active_movement_minutes, active_hours_count) to vitals_daily
--
-- Adds:
...
-- Step 1: Ensure all required columns exist in vitals_daily table
